...
function pages(): Record<string, { title: string; eyebrow: string; body: string }> {
  return {
    about: {
      eyebrow: "Company",
      title: "About us",
      body: `${theme.name} is a discovery platform for verified businesses and skilled professionals. We help people find considered partners for home, business, and everyday needs — and we help providers reach customers who are already looking.`,
    },
    careers: {
      eyebrow: "Company",
      title: "Careers",
    ...
    terms: {
      ...
      body: `By using ${theme.name} you agree to browse, save, and contact providers in good faith. Listings are provided by independent businesses. ${theme.name} does not guarantee availability, pricing, or outcomes of any engagement.`,
    },
    privacy: {
      eyebrow: "Legal",
    ...
    contact: {
      eyebrow: "Support",
      title: "Contact us",
      body: `For help with an account, listing, or provider profile, sign in and use My account. For partnership or press enquiries, reach us through your ${theme.name} account email once registered.`,
    },
  };
}
